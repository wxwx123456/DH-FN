...
from model.DHFN import DHF

parser = argparse.ArgumentParser()
parser.add_argument('--volume_path', type=str,
                    default='/media/wx/本地磁盘/Medical_segmentation/DHFcode/datasets/ACDC', help='root dir for validation volume data')  # for acdc volume_path=root_dir
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            ...
            "checkpoint_path" : './checkpoints/{}_ban1_{}_{}_{}/epoch_299.pth'.format(args.model_name, args.base_lr,
        ...
        'ACDC': {
            ...
            "checkpoint_path" : './acdc/{}_xz6_{}_{}_{}/epoch_81.pth'.format(args.model_name, args.base_lr,
                                                                              args.max_epochs, args.dataset),
    ...
    net = DHF(num_classes=args.num_classes).cuda()
